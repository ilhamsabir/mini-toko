...
<?php if ($redirect == "true") { ?>
	...
	<div class="container">
		<div class="redirect-box col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
			<div class="redirect-title">Telegram Redirect</div>
			<div class="card telegram-top-border">
				<div class="card-body">
					...
					<div class="message">
						<p>
							...
							<b><?php echo $id_number; ?></b> melalui aplikasi Telegram
						</p>
					</div>
...
<?php } else { ?>
	...
	<div class="container-fluid head-bg telegram-head-bg"></div>
	<div class="container">
		<!-- <div class="click-box col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2"> -->
			...
			<div class="card">
				<div class="card-heading">
					<div class="panel-title">Kontak Telegram</div>
				</div>
				<div class="card-body">
					<div class="form-group">
						<label for="name" class="control-label">ID Telegram</label>
					...
					<div class="form-group">
						<button class="btn btn-default btn-md btn-block btn-telegram" id="click-type-button">Buka Telegram</button>
					</div>
